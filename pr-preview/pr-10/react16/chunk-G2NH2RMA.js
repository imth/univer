...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-GTE3V5UW.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-LMNCIPPO.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-P2VZBC6C.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-V4JBTWZL.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-TI2Q33DT.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-PVNL4ET7.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-XPJHNPFI.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-TT3B3FSQ.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-J2FNYBDV.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-KMCBXPL7.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-TEUKMAZJ.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-EUEXXBYI.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "6da901e";
        const gitBranch = "fix/docx-multi-section-header-carryforward";
        const buildTime = "2026-05-06T16:03:59.302Z";

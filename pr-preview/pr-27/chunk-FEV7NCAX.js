...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-FCGHIWUT.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-EEKAGWBP.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-6UDDKUWV.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-PDIYOIPF.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-IG6IVFIG.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-AZWKVJ6B.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-DMTMKGQ7.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-UBXVAMBO.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-OK5SYOMP.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-SQWV4SLD.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-754OQHFP.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-7LT2CHKB.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "35bb6ca";
        const gitBranch = "feat/docx-image-rotation-flip-crop";
        const buildTime = "2026-06-01T11:29:58.677Z";

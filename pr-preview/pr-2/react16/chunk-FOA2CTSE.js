...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-LM3HAQVV.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-NNM6KAES.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-YFQ3RCDX.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-PDEBISRQ.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-BR44XRCC.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-VP3IGQ73.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-TIFFYYEO.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-MWE7YYQ2.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-UL6AGCFY.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-EG5IJAOM.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-XIF5GQBP.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-TAXYMIFF.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "65fa555";
        const gitBranch = "feat/doc-ieport";
        const buildTime = "2026-04-29T09:40:19.211Z";

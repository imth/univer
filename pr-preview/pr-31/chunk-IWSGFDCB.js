...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-Z6NEUFO4.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-UDB5DQYB.js");
        break;
      case "zhHK" /* ZH_HK */:
        locales2 = await import("./zh-HK-PNURARZS.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-SXV6RWQL.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-HFOYFPA7.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-PTM7EEVG.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-OZCJM4L7.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-Z5XIRMWK.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-OYBU5K32.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-3XRSNHYW.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-S7XHW75H.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-3LBSWNLD.js");
        break;
      case "ptBR" /* PT_BR */:
        locales2 = await import("./pt-BR-DSZNXVAT.js");
        break;
      case "deDE" /* DE_DE */:
        locales2 = await import("./de-DE-V4D4W3OS.js");
        break;
      case "itIT" /* IT_IT */:
        locales2 = await import("./it-IT-AP3UE7CB.js");
        break;
      case "idID" /* ID_ID */:
        locales2 = await import("./id-ID-RN4YBKUB.js");
        break;
      case "plPL" /* PL_PL */:
        locales2 = await import("./pl-PL-VQ363SFK.js");
        break;
      case "arSA" /* AR_SA */:
        locales2 = await import("./ar-SA-EUDOHHVZ.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-2VSNPASX.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "c2cff05";
        const gitBranch = "fix/paragraph-border-and-table-pagination";
        const buildTime = "2026-06-02T08:25:49.524Z";
